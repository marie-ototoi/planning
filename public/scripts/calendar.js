...
var css = "body{font-family:Arial,Helvetica,sans-serif;padding:0;margin:0}.hidden{display:none}.timeline{margin:0;padding:0 0 0 5px;background:#333}.timeline ul{display:flex;padding:0;margin:0}.timeline li{list-style-type:none;font-size:.8em;flex:1 1 20px;display:flex;flex-direction:column;justify-content:flex-end;color:#e6e6e6}.timeline li span{border-left:1px solid #e6e6e6;text-align:center;padding-bottom:4px}.timeline li span.year{padding-top:5px;padding-bottom:5px;padding-left:5px;color:#999}.timeline li span.month{cursor:pointer}.timeline li.active{color:#ff0096}.timeline li.active span{border-color:#ff0096}p.welcome{color:#ff0096;text-align:center;margin:0;padding:15px 0 0;font-size:.85em;font-weight:700}.calendar{padding:15px 0;display:flex;justify-content:space-between;align-items:center}.calendar__next,.calendar__previous{color:#e6e6e6;font-size:10em;font-weight:700;flex:1 0 50px;text-align:center;cursor:pointer}.calendar__list{flex:0 0 510px}.calendar__list h1{color:#c6c6c6;text-align:center;font-weight:400;font-size:1.3em;padding:0 0 10px;margin:0}.calendar__rows{border:10px solid #f6f6f6;border-radius:5px;background:#f6f6f6;min-height:420px}.calendar__row{display:flex;justify-content:flex-start}.calendar__row_first{justify-content:flex-end}.calendar__day{flex:0 1 70px;padding:25px 0;text-align:center;background:#e6e6e6;border-radius:3px;border:1px solid #fff;color:#333}.calendar__day_today{font-weight:700;border:1px solid #333}.IL{background:#93b9d1}.LO{background:#b9d1b5}.CO{background:#d38571}.SC{background:#f4c954}footer ul{display:flex;justify-content:center}footer li{border-left:10px solid #e6e6e6;list-style-type:none;font-size:.8em;padding:5px;margin-right:25px;color:#666}footer .CO,footer .HO,footer .IL,footer .LO,footer .SC{background:0 0}footer .IL{border-color:#93b9d1}footer .LO{border-color:#a2c09d}footer .CO{border-color:#d38571}footer .SC{border-color:#f4c954}footer .HO{border-color:#e6e6e6}"; (require("browserify-css").createStyle(css, { "href": "browser/app.css" }, { "insertAt": "bottom" })); module.exports = css;
...
console.log("toto", document)
},{"./app.css":1,"./scripts/calendar":3,"bootstrap/dist/css/bootstrap.css":4}],3:[function(require,module,exports){
var d3 = require('d3'),
