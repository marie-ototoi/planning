...
var css = "body{font-family:Arial,Helvetica,sans-serif;padding:0;margin:0}.container-fluid{padding:0}.hidden{display:none}p.welcome{text-align:right;margin:0;padding:15px 0 0;font-size:.9em;font-weight:700}.timeline{margin:0;padding:0 0 0 5px;background:#333}.timeline__list{display:flex;padding:0;margin:0}.timeline__item{list-style-type:none;font-size:.8em;flex:1 1 20px;display:flex;flex-direction:column;justify-content:flex-end;color:#e6e6e6}.timeline__item span{border-left:1px solid #e6e6e6;text-align:center;padding-bottom:4px}.timeline__year{padding-top:5px;padding-bottom:5px;padding-left:5px;color:#999}.timeline__month{cursor:pointer}.timeline__item.active{color:#ff0096}.timeline__item.active span{border-color:#ff0096}.calendar{padding:15px 0;display:flex;justify-content:space-between;align-items:center}.calendar__next,.calendar__previous{color:#e6e6e6;font-size:10em;font-weight:700;flex:1 0 50px;text-align:center;cursor:pointer}.calendar__list{flex:0 0 510px}.calendar__list h1{color:#c6c6c6;text-align:center;font-weight:400;font-size:1.3em;padding:0 0 10px;margin:0}.calendar__rows{border:10px solid #f6f6f6;border-radius:5px;background:#f6f6f6;min-height:454px}.calendar__row{display:flex;justify-content:flex-start}.calendar__row_first{justify-content:flex-end}.calendar__day{flex:0 1 70px;padding:25px 0;text-align:center;background:#e6e6e6;border-radius:3px;border:1px solid #fff;color:#333}.calendar__day_today{font-weight:700;border:1px solid #333}.IL{background:#93b9d1}.LO{background:#b9d1b5}.CO{background:#d38571}.SC{background:#f4c954}.legend{display:flex;justify-content:center}.legend__item{border-left:10px solid #e6e6e6;list-style-type:none;font-size:.8em;padding:5px;margin-right:25px;color:#666}.legend__item.CO,.legend__item.HO,.legend__item.IL,.legend__item.LO,.legend__item.SC{background:0 0}.legend__item.IL{border-color:#93b9d1}.legend__item.LO{border-color:#a2c09d}.legend__item.CO{border-color:#d38571}.legend__item.SC{border-color:#f4c954}.legend__item.HO{border-color:#e6e6e6}.config{background:#ededed;padding-top:30px}form{width:100%;background:#fff;padding:60px 30px;border-radius:10px}.login{background:#ededed;padding-top:30px}.login__header{background:#fff;padding:60px 30px;border-radius:10px}.login__header p{padding-bottom:30px}"; (require("browserify-css").createStyle(css, { "href": "browser/app.css" }, { "insertAt": "bottom" })); module.exports = css;
...
d3 = require('d3')
},{"./app.css":1,"./scripts/calendar":3,"bootstrap/dist/css/bootstrap.css":4,"d3":8}],3:[function(require,module,exports){
const d3 = require('d3'),
